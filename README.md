...
- Introduce interactive mini-games in the app starting 5 days prior to the event (e.g., "Spin the Wheel" or "Coupon Catcher"). Users can unlock mystery vouchers that increase in value depending on their consecutive daily check-in streak, driving daily app opens and habit-building prior to the sale.
