...
- Post-Event "Second Chance" Coupons: Send a "Last Call" email to users who browsed but didn't buy, offering a 24-hour extension on shipping promotions for all specific categories. This captures the "FOMO" (Fear Of Missing Out) from users who regret not pulling the trigger during the main event.
