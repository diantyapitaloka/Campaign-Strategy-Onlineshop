...
- In the 3 days leading up to the Twin Date, every item a user adds to their cart enters them into a daily sweepstakes where Toko A pays for their entire cart (up to $1,000). This incentivizes users to build massive, ready-to-checkout carts well before the flash sale goes live.
