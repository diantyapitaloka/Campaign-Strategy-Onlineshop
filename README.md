...
- Introduce a real-time price match shield during the event. If a customer finds the exact same item cheaper on a competitor platform within 2 hours of purchase, Toko A refund at 200% of the price difference in store credit. This removes price hesitation and keeps shoppers from leaving the apps to price-compare.
