...
- Early-Bird "Check-in" Rewards: Encourage users to visit the app daily for seven days leading up to the sale to collect "Event Coins" or exclusive vouchers. This is more like habit-building mechanic ensures Toko A is the first app a user opens the moment the clock strikes midnight.
